...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MyUser.send_restrict'
        db.add_column(u'user_mode_myuser', 'send_restrict',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MyUser.send_restrict'
        db.delete_column(u'user_mode_myuser', 'send_restrict')
